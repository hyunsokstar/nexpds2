...
function SktComponent() {
  return (
    // Remove the overflow-auto from the outer div and add flex flex-col h-full
    <div className="flex flex-col h-full">
      {/* Add a container div with h-full and overflow-x-auto */}
      <div className="h-full overflow-x-auto">
        {/* Keep the flex container for cards but remove the fixed width */}
